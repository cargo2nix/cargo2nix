  ...
  (self:
    {
        ...
        dependencies = [
          {
            ...
            package-id = "backtrace 0.3.31 (registry+https://github.com/rust-lang/crates.io-index)";
          }
          {
            toml-names = [
              "failure_derive"
      ...
      "registry+https://github.com/rust-lang/crates.io-index".backtrace."0.3.31" = mkRustCrate {
        package-id = "backtrace 0.3.31 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "backtrace";
          version = "0.3.31";
          sha256 = "e0f77aa27f55a4beb477ff6bc4d9bf72f90eb422b19c1d8e5a644b8aeb674d66";
          source-info = {
            index = "registry+https://github.com/rust-lang/crates.io-index";
          };
        };
