  ...
  (self:
    {
      ...
      "registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.93" = mkRustCrate {
        package-id = "serde_derive 1.0.93 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "serde_derive";
          version = "1.0.93";
          sha256 = "c4cce6663696bd38272e90bf34a0267e1226156c33f52d3f3915a2dd5d802085";
          source-info = {
            index = "registry+https://github.com/rust-lang/crates.io-index";
          };
        };
        dependencies = [
          ...
          }
          {
            ...
            extern-name = "syn";
            package-id = "syn 0.15.38 (registry+https://github.com/rust-lang/crates.io-index)";
          }
        ];
        cargo-manifest = {
          package = {
      ...
      "registry+https://github.com/rust-lang/crates.io-index".cargo."0.36.0" = mkRustCrate {
        ...
        dependencies = [
          ...
          }
          {
            ...
            package-id = "env_logger 0.6.1 (registry+https://github.com/rust-lang/crates.io-index)";
          }
          {
            toml-names = [
              "failure"
          ...
          }
          {
            ...
            extern-name = "flate2";
            package-id = "flate2 1.0.9 (registry+https://github.com/rust-lang/crates.io-index)";
          }
          {
            toml-names = [
              "fs2"
          ...
          }
          {
            ...
            extern-name = "serde";
            package-id = "serde 1.0.93 (registry+https://github.com/rust-lang/crates.io-index)";
          }
          {
            toml-names = [
              "serde_ignored"
      ...
      "registry+https://github.com/rust-lang/crates.io-index".globset."0.4.4" = mkRustCrate {
        ...
        dependencies = [
          ...
          }
          {
            ...
            extern-name = "bstr";
            package-id = "bstr 0.2.1 (registry+https://github.com/rust-lang/crates.io-index)";
          }
          {
            toml-names = [
              "fnv"
      ...
      "registry+https://github.com/rust-lang/crates.io-index".backtrace-sys."0.1.29" = mkRustCrate {
        package-id = "backtrace-sys 0.1.29 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "backtrace-sys";
          version = "0.1.29";
      ...
      "registry+https://github.com/rust-lang/crates.io-index".syn."0.15.38" = mkRustCrate {
        package-id = "syn 0.15.38 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "syn";
          version = "0.15.38";
          sha256 = "37ea458a750f59ab679b47fef9b6722c586c5742f4cfe18a120bbc807e5e01fd";
          source-info = {
            index = "registry+https://github.com/rust-lang/crates.io-index";
          };
        };
      ...
      "registry+https://github.com/rust-lang/crates.io-index".env_logger."0.6.1" = mkRustCrate {
        package-id = "env_logger 0.6.1 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "env_logger";
      ...
      "registry+https://github.com/rust-lang/crates.io-index".backtrace."0.3.32" = mkRustCrate {
        package-id = "backtrace 0.3.32 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "backtrace";
          version = "0.3.32";
      ...
      "registry+https://github.com/rust-lang/crates.io-index".bstr."0.2.1" = mkRustCrate {
        package-id = "bstr 0.2.1 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "bstr";
          version = "0.2.1";
          sha256 = "6cc0572e02f76cb335f309b19e0a0d585b4f62788f7d26de2a13a836a637385f";
          source-info = {
            index = "registry+https://github.com/rust-lang/crates.io-index";
          };
        };
      ...
      "registry+https://github.com/rust-lang/crates.io-index".flate2."1.0.9" = mkRustCrate {
        package-id = "flate2 1.0.9 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "flate2";
          version = "1.0.9";
          sha256 = "550934ad4808d5d39365e5d61727309bf18b3b02c6c56b729cb92e7dd84bc3d8";
          source-info = {
            index = "registry+https://github.com/rust-lang/crates.io-index";
          };
        };
      ...
      "registry+https://github.com/rust-lang/crates.io-index".serde."1.0.93" = mkRustCrate {
        package-id = "serde 1.0.93 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "serde";
          version = "1.0.93";
          sha256 = "960e29cf7004b3b6e65fc5002981400eb3ccc017a08a2406940823e58e7179a9";
          source-info = {
            index = "registry+https://github.com/rust-lang/crates.io-index";
          };
        };
