  ...
  (self:
    {
      ...
      unknown.cargo2nix."0.2.0" = mkRustCrate {
        ...
        dependencies = [
          ...
          }
          {
            ...
            extern-name = "nom";
            package-id = "nom 5.0.0 (registry+https://github.com/rust-lang/crates.io-index)";
          }
          {
            toml-names = [
              "regex"
      ...
      "registry+https://github.com/rust-lang/crates.io-index".lexical-core."0.4.3" = mkRustCrate {
        package-id = "lexical-core 0.4.3 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "lexical-core";
          version = "0.4.3";
          sha256 = "b8b0f90c979adde96d19eb10eb6431ba0c441e2f9e9bdff868b2f6f5114ff519";
          source-info = {
            index = "registry+https://github.com/rust-lang/crates.io-index";
          };
        };
        dependencies = [
          ...
          }
          {
            ...
            extern-name = "stackvector";
            package-id = "stackvector 1.0.6 (registry+https://github.com/rust-lang/crates.io-index)";
          }
          {
            toml-names = [
              "static_assertions"
            ];
            extern-name = "static_assertions";
            package-id = "static_assertions 0.3.4 (registry+https://github.com/rust-lang/crates.io-index)";
          }
        ];
        cargo-manifest = {
          package = {
      ...
      "registry+https://github.com/rust-lang/crates.io-index".nom."5.0.0" = mkRustCrate {
        package-id = "nom 5.0.0 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "nom";
          version = "5.0.0";
          sha256 = "e9761d859320e381010a4f7f8ed425f2c924de33ad121ace447367c713ad561b";
          source-info = {
            index = "registry+https://github.com/rust-lang/crates.io-index";
          };
        };
      ...
      "registry+https://github.com/rust-lang/crates.io-index".stackvector."1.0.6" = mkRustCrate {
        package-id = "stackvector 1.0.6 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "stackvector";
          version = "1.0.6";
          sha256 = "1c4725650978235083241fab0fdc8e694c3de37821524e7534a1a9061d1068af";
          source-info = {
            index = "registry+https://github.com/rust-lang/crates.io-index";
          };
        };
        dependencies = [
          ...
          }
          {
            ...
            extern-name = "unreachable";
            package-id = "unreachable 1.0.0 (registry+https://github.com/rust-lang/crates.io-index)";
          }
        ];
        cargo-manifest = {
          package = {
      ...
      "registry+https://github.com/rust-lang/crates.io-index".static_assertions."0.3.4" = mkRustCrate {
        package-id = "static_assertions 0.3.4 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
      ...
      "registry+https://github.com/rust-lang/crates.io-index".unreachable."1.0.0" = mkRustCrate {
        package-id = "unreachable 1.0.0 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "unreachable";
