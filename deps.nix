  ...
  (self:
    {
      ...
      "registry+https://github.com/rust-lang/crates.io-index".curl-sys."0.4.18" = mkRustCrate {
        package-id = "curl-sys 0.4.18 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "curl-sys";
          version = "0.4.18";
          sha256 = "9d91a0052d5b982887d8e829bee0faffc7218ea3c6ebd3d6c2c8f678a93c9a42";
          source-info = {
            index = "registry+https://github.com/rust-lang/crates.io-index";
          };
        };
