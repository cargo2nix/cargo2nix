  ...
  (self:
    {
      ...
      "registry+https://github.com/rust-lang/crates.io-index".cargo."0.36.0" = mkRustCrate {
        ...
        dependencies = [
          ...
          }
          {
            ...
            extern-name = "flate2";
            package-id = "flate2 1.0.8 (registry+https://github.com/rust-lang/crates.io-index)";
          }
          {
            toml-names = [
              "fs2"
      ...
      "registry+https://github.com/rust-lang/crates.io-index".flate2."1.0.8" = mkRustCrate {
        package-id = "flate2 1.0.8 (registry+https://github.com/rust-lang/crates.io-index)";
        src = config.resolver {
          source = "registry+https://github.com/rust-lang/crates.io-index";
          name = "flate2";
          version = "1.0.8";
          sha256 = "246b6f24d8e616b0c176a8143486ddc8bb0bac2f30f0a0d3efbcf1e0d47cb7e5";
          source-info = {
            index = "registry+https://github.com/rust-lang/crates.io-index";
          };
        };
