# This file was @generated by cargo2nix 0.8.0.
...
in
{
  cargo2nixVersion = "0.8.0";
  workspace = {
    cargo2nix = rustPackages."unknown".cargo2nix."0.8.0";
  };
  ...
  "unknown".cargo2nix."0.8.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo2nix";
    version = "0.8.0";
    registry = "unknown";
    src = fetchCrateLocal ./.;
