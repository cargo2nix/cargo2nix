# This file was @generated by cargo2nix 0.9.1.
...
in
{
  cargo2nixVersion = "0.9.1";
  workspace = {
    cargo2nix = rustPackages.unknown.cargo2nix."0.9.1";
  };
  ...
  "unknown".cargo2nix."0.9.1" = overridableMkRustCrate (profileName: rec {
    name = "cargo2nix";
    version = "0.9.1";
    registry = "unknown";
